...
<head>
  ...
  <!-- Vendor CSS -->
  <link rel="stylesheet" href="{{ asset('backend/css/libs.bundle.css') }}" />

  <!-- Main CSS -->
  <link rel="stylesheet" href="{{ asset('backend/css/theme.bundle.css') }}" />
...
<body class="">
  ...
  <!-- Theme JS -->
  <!-- Vendor JS -->
  <script src="{{ asset('backend/js/vendor.bundle.js') }}"></script>

  <!-- Theme JS -->
  <script src="{{ asset('backend/js/theme.bundle.js') }}"></script>
</body>
